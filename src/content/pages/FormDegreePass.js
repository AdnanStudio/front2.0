...
export default function FormDegreePass() {
  return (
    <ContentPageShell title="Form Fill-Up" banglaTitle="স্নাতক পাস ফর্ম পূরণ" icon="📝"
      ...
      <Section title="স্নাতক পাস ফর্ম পূরণ — নির্দেশাবলি">
        <p>নির্ধারিত সময়সীমার মধ্যে ফর্ম পূরণ সম্পন্ন করতে হবে। নিচের ধাপগুলো অনুসরণ করুন।</p>
      </Section>
      <InfoBox title="ফর্ম পূরণের ধাপসমূহ" items={['www.nu.ac.bd/admissions তে লগইন করুন','নির্ধারিত ফি অনলাইনে পরিশোধ করুন','প্রিন্ট করে কলেজে জমা দিন এবং সিল-স্বাক্ষর নিন','সময়সীমা মেনে চলুন']} />
