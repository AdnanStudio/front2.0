...
export default function FormHsc() {
  return (
    <ContentPageShell title="Form Fill-Up" banglaTitle="এইচএসসি ফর্ম পূরণ" icon="📝"
      ...
      <Section title="এইচএসসি ফর্ম পূরণ — নির্দেশাবলি">
        <p>নির্ধারিত সময়সীমার মধ্যে ফর্ম পূরণ সম্পন্ন করতে হবে। নিচের ধাপগুলো অনুসরণ করুন।</p>
      </Section>
      <InfoBox title="ফর্ম পূরণের ধাপসমূহ" items={['ঢাকা শিক্ষা বোর্ডের ওয়েবসাইটে অনলাইনে আবেদন করুন','নির্ধারিত ফি নগদ/বিকাশ/রকেট দিয়ে পরিশোধ করুন','পরিশোধের রসিদ কলেজ অফিসে জমা দিন','রেজিস্ট্রেশন নম্বর ও বিষয় কোড সঠিক কিনা যাচাই করুন','ছবি ও স্বাক্ষর সঠিকভাবে আপলোড করুন','নির্ধারিত সময়সীমার আগেই জমা দিন']} />
